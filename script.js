...
const emojiGroups = {
    "😊": [
        [0x1F600, 0x1F64F], // Основные смайлы
        [0x1F910, 0x1F917], // Доп. лица
        [0x1F920, 0x1F92F]  // Эмоции
    ],
    "🐱": [
        [0x1F400, 0x1F43E], // Животные
        [0x1F980, 0x1F997], // Экзотические животные
        [0x1F330, 0x1F37F]  // Растения и еда (начало)
    ],
    "🍔": [
        [0x1F344, 0x1F37C], // Фрукты, овощи, готовая еда
        [0x1F950, 0x1F96B]  // Современная еда
    ],
    "⚽": [
        [0x1F3C2, 0x1F3C4], // Спорт
        [0x1F3C6, 0x1F3CA], // Медали и заплывы
        [0x1F947, 0x1F94B], // Бокс, боевые искусства
        [0x1F3D4, 0x1F3EE]  // Места и хобби
    ],
    "🚗": [
        [0x1F680, 0x1F6C5], // Транспорт
        [0x1F300, 0x1F320]  // Погода и космос
    ],
    "💡": [
        [0x1F4BB, 0x1F4FB], // Техника (компьютеры, телефоны)
        [0x231A, 0x231B],   // Часы
        [0x1F4A1, 0x1F4A9], // Лампочки и эффекты
        [0x1F500, 0x1F53D]  // Кнопки и значки
    ],
    "🇺🇦": [
        [0x1F1E6, 0x1F1FF], // Буквы для флагов
        [0x1F004, 0x1F004], // Маджонг (редкое)
        [0x2600, 0x26FF]    // Символы (звезды, знаки зодиака)
    ]
};
